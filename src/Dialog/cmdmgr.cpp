...
////@begin cmdMgr content construction
    ...
    itemToolBar3->AddTool(ID_TOOL_ADD, _T("Ìí¼Ó"), itemtool4Bitmap, itemtool4BitmapDisabled, wxITEM_NORMAL, wxEmptyString, wxEmptyString);
    wxBitmap itemtool5Bitmap(itemDialog1->GetBitmapResource(wxT("paste.xpm")));
    wxBitmap itemtool5BitmapDisabled;
    itemToolBar3->AddTool(ID_TOOL_EDIT, _T("±à¼­"), itemtool5Bitmap, itemtool5BitmapDisabled, wxITEM_NORMAL, wxEmptyString, wxEmptyString);
    wxBitmap itemtool6Bitmap(itemDialog1->GetBitmapResource(wxT("cut.xpm")));
    wxBitmap itemtool6BitmapDisabled;
    itemToolBar3->AddTool(ID_TOOL_DELETE, _T("É¾³ý"), itemtool6Bitmap, itemtool6BitmapDisabled, wxITEM_NORMAL, wxEmptyString, wxEmptyString);
    itemToolBar3->AddSeparator();
    wxBitmap itemtool8Bitmap(itemDialog1->GetBitmapResource(wxT("find.xpm")));
    wxBitmap itemtool8BitmapDisabled;
    itemToolBar3->AddTool(ID_TOOL_CHECK, _T("Ð£Ñé"), itemtool8Bitmap, itemtool8BitmapDisabled, wxITEM_NORMAL, wxEmptyString, wxEmptyString);
